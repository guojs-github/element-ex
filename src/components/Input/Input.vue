    ...
    <div class='test-item input'>
		...
		<div class='row size'>
			<div class='input-item'>
				<el-input placeholder="请输入内容" suffix-icon="el-icon-date" v-model="input6" width='100px'>
				</el-input>
			</div>
			<div class='input-item'>
		...
		<div class='hint'>搜索输入典型应用</div>

		<div class='row search'>
			<el-autocomplete 
				popper-class="my-autocomplete" 
				v-model="state" 
				:fetch-suggestions="filt" 
				placeholder="请输入内容" 
				@select="onSelect">
...
<script>
	export default {
		...
		mounted () {
			...
			this.restaurants = this.query()
		},
		
		methods: {		
			onSelect (e) {
				console.log('On select search input box')
			},

			onClickIcon (e) {
				console.log('On click icon of search input box')
			},
...
<style scoped src='./Input.less' lang='less'/>
<style scoped>
</style>
